...
Feature: Footnote
  ...
  Scenario Outline: Footnote in author rollover
    ...
    Then I should see "VOR 05227" in the "h1" elementGiven I am on "<article_url>"
    And I hover over the author "<author>" in the ".elife-article-author-item" element
    Then I should see the "author-info" tooltip

  Examples:
    | article_url                   | author                  |
    | content/3/e00013/article-info | RB Forward |
    | content/3/e00013/article-info | TA Ziegler |