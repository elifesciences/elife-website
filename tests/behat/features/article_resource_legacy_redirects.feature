Feature: Article Resource - Legacy Redirects
  In order to route users to the latest pdf
  As a website visitor
  We must honour the old format of links to the full pdf
  ...
  Scenario: Old style PDF urls redirect to latest version of an article's pdf
    ...
    Then I should be redirected to "http://parallel-elife-publishing-cdn.s3.amazonaws.com/05224/elife-05224-v2.pdf" with a 302
    ...
    Given there is an article:
      ...
      """
    When I go to "content/4/e05224.full.pdf"
    Then I should be redirected to "http://parallel-elife-publishing-cdn.s3.amazonaws.com/05224/elife-05224-v3.pdf" with a 302
