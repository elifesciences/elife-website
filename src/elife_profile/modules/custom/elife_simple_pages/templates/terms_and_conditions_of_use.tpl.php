<h3>Welcome and Consent to Terms</h3>

<p>eLife Sciences Publications, Ltd. ("eLife") is a 501(c)(3) nonprofit
  ...
  access and use the eLife Sites and should cease doing so immediately.</p>

<h3>Ownership</h3>

<p>The eLife Sites, the software ("eLife Software"), application programming
...
<h3>License to Use Journal Articles and Related Content</h3>

<p>Unless otherwise indicated, the articles and journal content published by
  ...
  to citation of the original source in accordance with the CC-BY license.</p>

<h3>Impermissible Uses</h3>

<p>You agree to use the eLife Sites only for lawful purposes, and in a manner
  ...
  website. As a condition to your use of the eLife Sites, you agree not to:</p>

<ul>
  <li>upload, post, e-mail, transmit, or otherwise make available any
  ...
  <li>upload, post, e-mail, transmit, or otherwise make available to any user of
  ...
  <li>modify, adapt, or hack the eLife Sites or falsely imply that some other
    site is associated with the eLife Sites or eLife; or
  </li>
  <li>use the eLife Sites for any illegal or unauthorized purpose. You must not,
    in the use of the eLife Sites, violate any US laws or laws in your
    jurisdiction (including but not limited to copyright laws).
  </li>
</ul>

<h3>Suspension of Use / Violation of these Terms and Conditions</h3>

<p>eLife reserves the right to limit, suspend, or terminate your access and use
  ...
  violates these Terms and Conditions or that is otherwise objectionable.</p>

<h3>Disclaimer of Warranty</h3>

<p>The eLife Sites, including, without limitation, the eLife Software, the eLife
  ...
  functionality, accuracy, AND reliability of the materials.</p>

<h3>Limitation of Liability</h3>

<p>To the fullest extent permitted by law, in no event will the eLife Parties,
  ...
  THAT WAS NOT REASONABLY FORESEEABLE.</p>

<h3>Indemnity</h3>

<p>You are solely responsible for your actions in connection with the eLife
...
<ul>
  ...
  <li>unlawful disclosure or alteration of or interference of whatsoever nature
    by
  ...
  <li>any act or omission by you constituting breach of copyright, infringement
    of
...
<p>In the course of using the eLife Sites, you may provide eLife with feedback,
...
<h3>Links to Other Websites and Resources</h3>

<p>The eLife Sites may provide links to other websites or resources. Because
...
<h3>Modifications to eLife Site and Terms and Conditions</h3>

<p>eLife reserves the right to modify or discontinue, temporarily or
...
<h3>Additional Terms for Certain Features</h3>

<p>Certain parts of the eLife Sites may be subject to registration and
  ...
  steps to stop such use.</p>

<h3>General</h3>

<p>Any forbearance or indulgence by eLife in enforcing any provision in these
...
<p>If you have any questions or comments about these Terms and Conditions,
  please contact <a
    href="mailto:info@elifesciences.org">info@elifesciences.org</a></p>
