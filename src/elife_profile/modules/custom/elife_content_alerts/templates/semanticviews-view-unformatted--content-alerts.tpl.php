...
?>
<?php if (!empty($title)): ?>
  <<?php print $group_element; ?><?php print drupal_attributes($group_attributes); ?> style="font-size: 14px; font-weight: lighter; line-height: 22px; margin: 0; margin-bottom: 10px">
    <a name="<?php print strtolower(preg_replace('/[^a-zA-Z0-9-]+/', '-', $title)); ?>"><?php print $title; ?></a>
