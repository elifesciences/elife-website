                  ...
                  <tbody>
                    <tr>
                      <td>
                        ...
                        <p style="font-size:10px; line-height:22px; color:#929497;">Contact: Emily Packer on <a href="mailto:press@elifesciences.org" style="color: #0961AB;">press@elifesciences.org</a>, +44 (0)1223855373. Please cite <em>eLife</em> as the source of these articles and include a link to either the article or elifesciences.org. Thank you! More details available at <a href="https://elifesciences.org/for-the-press?utm_source=content_alert&utm_medium=email&utm_content=fulltext&utm_campaign=elife-alerts" style="color: #0961AB;">http://elifesciences.org/for-the-press</a>.</p>
                        <p style="font-size:10px; line-height:22px; color:#929497;">To be notified of new content at eLife, sign up at <a href="https://crm.elifesciences.org/crm/node/3?cid1={contact.contact_id}&{contact.checksum}" style="color: #0961AB;">https://crm.elifesciences.org/crm/node/3?cid1={contact.contact_id}&{contact.checksum}</a>.</p>
